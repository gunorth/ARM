...
# TFS 2015 Update 2
$TfsDownloadUrl = 'http://go.microsoft.com/fwlink/?LinkId=787600'
$InstallDirectory = 'C:\Program Files\Microsoft Team Foundation Server 14.0'
$InstallKey = 'HKLM:\SOFTWARE\Microsoft\DevDiv\tfs\Servicing\14.0\serverCore'
